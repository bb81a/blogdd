...
const components = {
  h1: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h1
      className={cn(
        'mt-2 scroll-m-4 text-4xl font-bold tracking-tight',
        className
      )}
      {...props}
    />
  ...
  h2: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h2
      className={cn(
        'mt-10 scroll-m-4 text-3xl font-semibold tracking-tight',
        className
      )}
      {...props}
    />
  ...
  h3: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h3
      className={cn(
        'mt-10 scroll-m-4 text-2xl font-semibold tracking-tight',
        className
      )}
      {...props}
    />
  ...
  h4: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h4
      className={cn(
        'mt-10 scroll-m-4 text-xl font-semibold tracking-tight',
        className
      )}
      {...props}
    />
  ...
  h5: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h5
      className={cn(
        'mt-10 scroll-m-4 text-lg font-semibold tracking-tight',
        className
      )}
      {...props}
    />
  ...
  h6: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h6
      className={cn(
        'mt-10 scroll-m-4 text-base font-semibold tracking-tight',
        className
      )}
      {...props}
    />
